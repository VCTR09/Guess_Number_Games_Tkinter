...
* При нажатии кнопки 'Сгенерировать число' появляется всплывающее окно
...
При нажатии на 'Старт' на экран выводится число. Если число не равно Вашему, воспользуйтесь кнопками '>' или '<', чтобы
дать компьютеру подсказку. Когда компьютер отгадает число, нажмите '='.
